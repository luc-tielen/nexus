...
2. Call the `create_task` MCP tool with the description as `content`.
...
Tool call: `create_task` with `content = "write unit tests for the auth module"`

Response: "Added to-do: write unit tests for the auth module"
